# ------------------------------------------------------------------------------
# Purpose: This script creates manhattan plots from univariate analysis for each 
# cluster and an UpSet plot showing the overlapping significantly associated proteins
# ------------------------------------------------------------------------------
