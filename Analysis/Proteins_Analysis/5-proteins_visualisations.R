# ------------------------------------------------------------------------------
# Purpose: This script creates an UpSet plot of the stably selected proteins per
# cluster, and a heatmap with the odds ratios for the proteins for each cluster
...
library(tidyr)
library(pheatmap)
selected_vars <- readRDS('/rds/general/project/hda_24-25/live/TDS/Group06/extraction_and_recoding/outputs/Protein_Analysis/selected_vars.rds')
hat_parameters <- readRDS('/rds/general/project/hda_24-25/live/TDS/Group06/extraction_and_recoding/outputs/Protein_Analysis/hat_parameters.rds')
