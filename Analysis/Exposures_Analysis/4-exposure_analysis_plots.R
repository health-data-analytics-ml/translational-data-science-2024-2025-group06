# ------------------------------------------------------------------------------
# Purpose: This script generates manhattan plots, an UpSet plot, and a barplot for
# univariate analysis. It also generates a tilemap of stably selected variables for 
# stability selection LASSO and a tilemap of odds ratios for logistic regression
# ------------------------------------------------------------------------------
...
# Stability selection LASSO (tile map) =========================================
