# ------------------------------------------------------------------------------
# Purpose: This script creates a logistic regression model for each cluster
# based on their stably selected exposures, evaluates performance with ROC curves,
# and checks for perfect separation in the original feature space
# ------------------------------------------------------------------------------
...
# Save and train logistic regression models for each cluster, save results =====
for (i in 1:7){
...
# Generate ROC curve for each cluster ==========================================
for(i in 1:7){
...
# Create graph with ROC curves from all clusters ===============================
...
# Looking at all of the perfectly separating variables - none!
