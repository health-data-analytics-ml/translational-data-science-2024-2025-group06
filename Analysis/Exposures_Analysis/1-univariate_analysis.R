# ------------------------------------------------------------------------------
# Purpose: This script runs univariate analysis for exposures and generates tables 
# to use in analysis_plots
# ------------------------------------------------------------------------------
...
# Build an empty matrix to add p-values from output of each univariate analysis
