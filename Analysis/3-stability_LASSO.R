# Stability LASSO
# The for loop generates and saves calibration plots and selection proportion plots
# each cluster
rm(list = ls())
...
for(i in 1:7){
  ...
  plot_name <- '/rds/general/project/hda_24-25/live/TDS/Group06/Scripts/Visualisations/Analysis_visuals/Selection_plots/C'
