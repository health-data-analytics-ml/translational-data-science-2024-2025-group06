# ------------------------------------------------------------------------------
# Purpose: This script analyses disease incidence across clusters using logistic
# regression. It generates heatmaps of standardized incidence, odds ratios, and 
# AUCs, both with and without selected exposures
# ------------------------------------------------------------------------------
...
# Print the resulting AUC matrix
print(AUC_results)
setwd('/rds/general/project/hda_24-25/live/TDS/Group06/Scripts/Disease_Analysis')
