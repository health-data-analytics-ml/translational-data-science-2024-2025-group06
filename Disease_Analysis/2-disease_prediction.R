# ------------------------------------------------------------------------------
# Purpose: This script evaluates disease risk across clusters using logistic 
# regression. It compares model performance for cluster-only, cluster+exposures, 
# and cluster+exposures+proteins using odds ratios and ROC/AUC curves
# ------------------------------------------------------------------------------
