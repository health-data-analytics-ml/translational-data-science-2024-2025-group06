# ------------------------------------------------------------------------------
# Purpose: This script identifies and removes outliers by excluding values that 
# lie more than ±3 standard deviations from the mean (outlier removal technique used)
# ------------------------------------------------------------------------------
