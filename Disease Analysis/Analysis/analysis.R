...
#copd <- read.csv('/rds/general/project/hda_24-25/live/TDS/Group06/outcome_definition/Definitions/Chronic_Obstructive_Pulmonary_Disease/Outputs/output_hes.rds')
...
# Number of control in each cluster -----------------------------------------
...
library(ROCR)  # For ROC performance analysis
