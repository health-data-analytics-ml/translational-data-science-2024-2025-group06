# ------------------------------------------------------------------------------
# Purpose: This script visualises the clusters from GMM using three different 
# dimensionality reduction techniques - PCA, UMAP, and t-SNE
# ------------------------------------------------------------------------------
...
# Density map and scatterplot UMAP =============================================
p <- ggplot() +  
