# ------------------------------------------------------------------------------
# Purpose: This script evaluates hierarchical clustering quality, and visualises 
# with dendograms and elbow plots
# uses https://medium.com/towards-data-science/hierarchical-clustering-on-categorical-data-in-r-a27e578f2995
# ------------------------------------------------------------------------------
...
divisive <- readRDS('/rds/general/project/hda_24-25/live/TDS/Group06/extraction_and_recoding/outputs/data_divi.rds')
